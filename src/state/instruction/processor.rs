    ...
    match instruction.opcode().form() {
        ...
        _ => match instruction.opcode().operand_count() {
            OperandCount::_0OP => match instruction.opcode().instruction() {
                ...
                //             0x1 => processor_0op::rfalse(context, instruction),
                //             0x2 => processor_0op::print(context, instruction),
                ...
                //             0xb => processor_0op::new_line(context, instruction),
            ...
            OperandCount::_1OP => match instruction.opcode().instruction() {
                ...
                //             0x1 => processor_1op::get_sibling(context, instruction),
                //             0x2 => processor_1op::get_child(context, instruction),
                //             0x3 => processor_1op::get_parent(context, instruction),
                //             0x4 => processor_1op::get_prop_len(context, instruction),
                0x5 => processor_1op::inc(state, instruction),
                //             0x6 => processor_1op::dec(context, instruction),
                ...
                //             0xa => processor_1op::print_obj(context, instruction),
                //             0xb => processor_1op::ret(context, instruction),
                //             0xc => processor_1op::jump(context, instruction),
                //             0xd => processor_1op::print_paddr(context, instruction),
            ...
            //             0x01 => processor_2op::je(context, instruction),
            //             0x02 => processor_2op::jl(context, instruction),
            ...
            //             0x09 => processor_2op::and(context, instruction),
            //             0x0a => processor_2op::test_attr(context, instruction),
            //             0x0b => processor_2op::set_attr(context, instruction),
            //             0x0c => processor_2op::clear_attr(context, instruction),
            //             0x0d => processor_2op::store(context, instruction),
            //             0x0e => processor_2op::insert_obj(context, instruction),
            //             0x0f => processor_2op::loadw(context, instruction),
            //             0x10 => processor_2op::loadb(context, instruction),
            //             0x11 => processor_2op::get_prop(context, instruction),
            ...
            OperandCount::_VAR => match instruction.opcode().instruction() {
                ...
                //             0x01 => processor_var::storew(context, instruction),
                0x02 => processor_var::storeb(state, instruction),
                //             0x03 => processor_var::put_prop(context, instruction),
                //             0x04 => processor_var::read(context, instruction),
                //             0x05 => processor_var::print_char(context, instruction),
                //             0x06 => processor_var::print_num(context, instruction),
