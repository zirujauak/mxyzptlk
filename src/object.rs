...
fn set_word(m: &mut Vec<u8>, a: usize, v: u16) {
    let hb = (v >> 8) as u8 & 0xFF;
    let lb = (v & 0xFF) as u8;
    m[a] = hb;
    m[a+1] = lb;
}
...
/// * `o` - Object number (1 - ...)
pub fn object_address(m: &Vec<u8>, v: u8, o: usize) -> usize {
    match v {
...
/// Set the parent object of an object.  This method does not update other objects
/// in the object tree (old parent, siblings).  Improper use can very easily result
/// in an invalid object tree state.
/// 
/// # Arguments:
/// 
/// * `m` - Memory map
/// * `v` - Version (1-8)
/// * `o` - Object number to update
/// * `p` - Parent object number
pub fn set_parent(m: &mut Vec<u8>, v: u8, o: usize, p: usize) {
    let oa = object_address(m, v, o);

    match v {
        1 | 2 | 3 => m[oa + 4] = p as u8,
        4 | 5 | 6 | 7 | 8 => set_word(m, oa + 6, p as u16),
        _ => {}
    }
}
...
/// Set the first sibling of an object.  This method does not update other objects
/// in the object tree.  Improper use can very easily result in an invalid object 
/// tree state.
/// 
/// # Arguments:
/// 
...
/// * `v` - Version (1-8)
/// * `o` - Object number to update
/// * `s` - Sibling object number
pub fn set_sibling(m: &mut Vec<u8>, v: u8, o: usize, s: usize) {
    let oa = object_address(m, v, o);

    match v {
        1 | 2 | 3 => m[oa + 5] = s as u8,
        4 | 5 | 6 | 7 | 8 => set_word(m, oa + 8, s as u16),
        _ => {}
    }
}
...
/// Set the first child of an object.  This method does not update other objects
/// in the object tree.  Improper use can very easily result in an invalid object 
/// tree state.
/// 
/// # Arguments:
...
/// * `v` - Version (1-8)
/// * `o` - Object number to update
/// * `c` - Child object number
pub fn set_child(m: &mut Vec<u8>, v: u8, o: usize, c: usize) {
    let oa = object_address(m, v, o);

    match v {
        1 | 2 | 3 => m[oa + 6] = c as u8,
        4 | 5 | 6 | 7 | 8 => set_word(m, oa + 10, c as u16),
        _ => {}
    }
}
...
/// * `v` - Version (1-8)
/// * `o` - Object number
pub fn property_table_address(m: &Vec<u8>, v: u8, o: usize) -> usize {
    let oa = object_address(m, v, o);
    match v {
...
/// * `o` - Object number
/// * `p` - Property number
pub fn has_property(m: &Vec<u8>, v: u8, o: usize, p: u8) -> bool {
    let pt = property_table_address(m, v, o);
    let hs = m[pt] as usize;
