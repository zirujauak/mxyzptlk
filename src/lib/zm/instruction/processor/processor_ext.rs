...
// pub fn print_unicode(context: &mut Context, instruction: &Instruction) -> Result<InstructionResult, ContextError> {
//     let operands = operand_values(context, instruction)?;
//     todo!()
// }

// pub fn check_unicode(context: &mut Context, instruction: &Instruction) -> Result<InstructionResult, ContextError> {
//     let operands = operand_values(context, instruction)?;
//     todo!()
// }

// pub fn set_true_colour(context: &mut Context, instruction: &Instruction) -> Result<InstructionResult, ContextError> {
//     let operands = operand_values(context, instruction)?;
//     todo!()
// }
